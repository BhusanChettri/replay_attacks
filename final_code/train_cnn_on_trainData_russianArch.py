...
def trainCNN_on_trainData():
    ...
    dropout1=[0.3,0.2,0.1]
    dropout2=[0.7,0.5,0.4,0.3,0.2]
    ...
    for duration in trainingSize:
        ...
        for dropout in dropout1:
            ...
            for drop in dropout2:
                ...
                hyp_str ='arch'+str(architecture)+'_keep_'+ str(dropout)+'_'+str(drop)+'_'+trainSize
                
                log_dir = '../tensorflow_log_dir/rusCNN_max2000epochs/'+ hyp_str
                model_save_path = '../models/rusCNN_max2000epochs/'+ hyp_str
                ...
                tLoss,vLoss,tAcc,vAcc=model.train(architecture,fftSize,padding,trainSize,t_data, t_labels,v_data,v_labels,activation,lr,use_lr_decay,epsilon,b1,b2,momentum,optimizer_type,dropout,drop,dropout3,model_save_path,log_dir,logfile,wDecayFlag,lossPenalty,applyBatchNorm,init_type,epochs,batch_size,targets)
