...
def cnnModel2(input_type,trainSize,input_placeholder,activation,init,targets,fftSize,padding,keep_prob1, keep_prob2, keep_prob3):
    ...
    # WE use google text dependent DNN setup with 10X10 filter in Conv layer.    
    ...
    # We just use f=10 and t=10, 10X10 convolution
    f=10
    ...
    conv1,w1,b1 = conv_layer(input_placeholder, [10,10,1,32], [32], [1,1,1,1],'conv1',padding,activation,init)
    weight_list.append(w1)
    bias_list.append(b1)
    print('Conv1 ', conv1)
    ...
    #Max-pooling layer over time    
    pool1 = maxPool2x2(conv1, [1,time_dim,1,1], [1,time_dim,1,1])
    print('Pool1 layer shape = ', pool1)
